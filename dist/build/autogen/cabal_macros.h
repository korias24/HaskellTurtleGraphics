...
/* package turtle-graphics-0.1.0.0 */
#define VERSION_turtle_graphics "0.1.0.0"
#define MIN_VERSION_turtle_graphics(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)

/* package HGL-3.2.3.1 */
#define VERSION_HGL "3.2.3.1"
#define MIN_VERSION_HGL(major1,major2,minor) (\
  (major1) <  3 || \
  (major1) == 3 && (major2) <  2 || \
...
#define CURRENT_COMPONENT_ID "turtle-graphics-0.1.0.0-5Z6WIc1yTjyItqvFECNpoT"

#define CURRENT_PACKAGE_KEY "turtle-graphics-0.1.0.0-5Z6WIc1yTjyItqvFECNpoT"
